namespace Fibers
{
    public class FibersStorage : IDisposable
    {
        ...
        private int FindPriority(FiberStructure fiber)
        {
            return fiber.Priority % maxPriority;
        }

        private bool IsEmptyList(List<FiberStructure> lst)
        {
            return lst.Count == 0;
        }
        ...
        {
            return IsEmptyList(fibersStorage[-1]);
        }
